...
**git merge branch_name** - соединяет ветку branch_name с веткой в которой мы сейчас находимся

**git branch -d branch_name** - удаление ветки branch_name

**git merge --abort** - отменяет последний merge

**git checkout -b branch_name** - создаем и переходим к созданной ветке.

**git log --graph** - показывает лог с графическим древовидным интерфейсом коммитов
